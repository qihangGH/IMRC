...
def config_parser(cmd=None):
    ...
    # export density
    parser.add_argument("--reso", type=str, default="512,512,512")
    parser.add_argument("--radius", type=str, default="1.,1.,1.")
    ...
    parser.add_argument('--dataset_name', type=str, default='llff',
                        choices=['blender', 'llff', 'nsvf', 'dtu', 'dtu_mvs',
                                 'tankstemple', 'own_data'])
    parser.add_argument('--dtu_scan', type=int, default=69)
    parser.add_argument('--dtu_mvs_scan', type=int, default=1)
    # training options
    # learning rate
    ...
    parser.add_argument("--weight_rgbper", default=0.0)
    parser.add_argument("--weight_entropy_last", default=0.0)
    parser.add_argument("--weight_distortion", default=0.0)

    # iteration starts from 0, so set to -1 to disable
    parser.add_argument("--start_learn_density", default=-1)
    ...
    parser.add_argument("--rm_weight_mask_thre", type=float, default=
    0.0001,
                        help='mask points in ray marching')
    parser.add_argument("--alpha_mask_thre", type=float, default=
    0.0001,
                        help='threshold for creating alpha mask volume')
    parser.add_argument("--distance_scale", type=float, default=
    25,
