...
torch::Tensor volume_render_sigma_thresh(SparseGridSpec &, RaysSpec &,
                                         RenderOptions &, float);
// Acc rendering
torch::Tensor volume_render_weight_term(SparseGridSpec &, RaysSpec &,
                                          RenderOptions &);
...
// IMRC
torch::Tensor estimate_color_metric(SparseGridSpec&, RenderOptions&,
...
#define _REG_FUNC(funname) m.def(#funname, &funname)
  ...
  _REG_FUNC(volume_render_weight_term);
  ...
  // IMRC
  _REG_FUNC(estimate_color_metric);
...
#undef _REG_FUNC
  ...
  py::class_<SparseGridSpec>(m, "SparseGridSpec")
      ...
      .def_readwrite("links_inverse", &SparseGridSpec::links_inverse)
      .def_readwrite("_offset", &SparseGridSpec::_offset)
      .def_readwrite("_scaling", &SparseGridSpec::_scaling)
      .def_readwrite("_offset_grid2world", &SparseGridSpec::_offset_grid2world)
      .def_readwrite("_scaling_grid2world", &SparseGridSpec::_scaling_grid2world)
