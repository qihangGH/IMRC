...
struct PackedSparseGridSpec {
    PackedSparseGridSpec(SparseGridSpec& spec)
        :
          ...
          links_inverse(spec.links_inverse.data_ptr<int32_t>()),
          ...
          _offset_grid2world{spec._offset_grid2world.data_ptr<float>()[0],
                             spec._offset_grid2world.data_ptr<float>()[1],
                             spec._offset_grid2world.data_ptr<float>()[2]},
          _scaling_grid2world{spec._scaling_grid2world.data_ptr<float>()[0],
                              spec._scaling_grid2world.data_ptr<float>()[1],
                              spec._scaling_grid2world.data_ptr<float>()[2]} {
    }
    ...
    const float _offset_grid2world[3];
    const float _scaling_grid2world[3];
};
