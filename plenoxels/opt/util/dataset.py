...
from .dtu_neus_dataset import DTUDataset
from os import path
...
def auto_dataset(root: str, *args, **kwargs):
    ...
    elif path.isfile(path.join(root, 'rect_001_0_r5000.png')):
        print("Detected DTU MVS dataset")
        return DTUMVSDataset(root, *args, **kwargs)
    else:
