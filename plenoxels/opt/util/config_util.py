...
def define_common_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--train_hold_every', default=None,
                       help='train with sparse views')
    group.add_argument('--test_hold_every', default=None,
                       help='test with sparse views')
    ...
    # color estimate
    group.add_argument_group("Color estimation options")
    group.add_argument("--high_fq", default=False, action="store_true",
                       help="Use high-frequency background for training data or not")
...
def build_data_options(args):
    ...
    return {
        ...
        'train_hold_every': args.train_hold_every,
        'test_hold_every': args.test_hold_every,
        'high_fq': args.high_fq,
    }
