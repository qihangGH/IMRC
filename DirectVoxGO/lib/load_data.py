...
from .load_dtu_mvs import load_dtu_mvs_data
...
def load_data(args):
    ...
    if args.dataset_type == 'llff':
        ...
        if args.train_hold_every is not None:
            i_train = i_train[::args.train_hold_every]
            print(f'Train with sparse views: {len(i_train)}')
        ...
        images, poses, render_poses, hwf, i_split = load_dv_data(scene=args.scene, basedir=args.datadir,
        ...
        images, poses, render_poses, hwf, K, i_split = load_dtu_data(args.datadir)
        # print('Loaded dtu', images.shape, render_poses.shape, hwf, args.datadir)
        print('Loaded dtu', images.shape, hwf, args.datadir)
        i_train, i_val, i_test = i_split
    ...
    elif args.dataset_type == 'dtu_mvs':
        images, poses, render_poses, hwf, K, i_split = load_dtu_mvs_data(args.datadir)
        print('Loaded dtu mvs', images.shape, hwf, args.datadir)
        i_train, i_val, i_test = i_split
